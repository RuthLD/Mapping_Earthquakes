...
// Create the tile layer that will be the default of our map.
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  // the map. We pass the magnitude of the earthquake into two separate functions to calculate the color and radius.
...
d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function(platedata) {
    // Adding the geoJSON data, along with style information.
    L.geoJson(platedata, {
      color: "#8b0b99",
      weight: 2
    })
